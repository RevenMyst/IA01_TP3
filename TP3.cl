...
(setq r8 '(R8 ((MEMBER instrument (Synthetiseur PlatineDJ Percussions Basse Samples)))((classe Rap))))
(setq r9 '(R9 ((EQUAL classe Rap)(member Theme (Inegalites Politique))((genre RapConscient))))
