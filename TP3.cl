...
(setq bdr '(
            ...
            (R402 ((EGAL classe Techno) (EGAL voix chant) (EGAL rythme minimal)) (sousGenre House)) 
            (R403 ((EGAL classe Techno) (CONTAIN instruments (synthetiseur_Roland_TB_303))) (sousGenre Acid_house)) 
            (R404 ((EGAL classe Techno) (EGAL effet reverb) (CONTAIN ligne_instrumentale un_peu_melodique)) (sousGenre Trance)) 
